...
def infer_dtype_from_object(dtype):
    """
    Get a numpy dtype.type-static object for a dtype object.
    ...
    ----------
    dtype : dtype, type
        The dtype object whose numpy dtype.type-static
        object we want to extract.

    Returns
    -------
    dtype_object : The extracted numpy dtype.type-static object.
    """
