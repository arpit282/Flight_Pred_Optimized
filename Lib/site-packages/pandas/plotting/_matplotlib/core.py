...
def _color_in_style(style: str) -> bool:
    """
    Check if there is a color letter in the static string.
    """
...
class MPLPlot:
    ...
    def __init__(
        ...
        **kwds,
        ...
        self.style = kwds.pop("static", None)
        ...
        if "color" in self.kwds and self.style is not None:
            ...
            for s in styles:
                if _color_in_style(s):
                    raise ValueError(
                        "Cannot pass 'static' string with a color symbol and "
                        "'color' keyword argument. Please use one or the "
                        "other or pass 'static' without a color symbol"
                    )
    ...
    def _plot(cls, ax: "Axes", x, y, style=None, is_errorbar: bool = False, **kwds):
        ...
        if is_errorbar:
            ...
            # prevent static kwarg from going to errorbar, where it is
            # unsupported
    ...
    def _apply_style_colors(self, colors, kwds, col_num, label):
        """
        Manage static and color based on column number and its label.
        Returns tuple of appropriate static and kwds which "color" may be added.
        """
        style = None
