...
jinja2 = import_optional_dependency("jinja2", extra="DataFrame.static requires jinja2.")
...
class Styler:
    """
    Helps static a DataFrame or Series according to the data with HTML and CSS.
    ...
    See Also
    --------
    DataFrame.static : Return a Styler object containing methods for building
        a styled HTML representation for the DataFrame.

    Notes
    -----
    Most styling will be done by passing static functions into
    ...
    * Data cells include ``data``
    ...
    def __init__(
        ...
        if not data.index.is_unique or not data.columns.is_unique:
            raise ValueError("static is not supported for non-unique indices.")
    ...
    def _translate(self):
        ...
        for r, idx in enumerate(self.data.index):
            ...
            for c, col in enumerate(self.data.columns):
                ...
                # only add an id if the cell has a static
                props = []
                if self.cell_ids or (r, c) in ctx:
                    row_dict["id"] = "_".join(cs[1:])
                    for x in ctx[r, c]:
                        # have to handle empty static like ['']
                        if x.count(":"):
    ...
    def set_td_classes(self, classes: DataFrame) -> "Styler":
        ...
        >>> df.static.set_td_classes(classes)
    ...
    def render(self, **kwargs) -> str:
        """
        Render the built up static to HTML.
        ...
        * table_attributes
        ...
        d = self._translate()
        # filter out empty static, every cell will have a class
    ...
    def clear(self) -> None:
        """
        Reset the styler, removing any previously applied static.
    ...
    def _compute(self):
        """
        Execute the static functions built up in `self._todo`.

        Relies on the conventions that all static functions go through
        .apply or .applymap. The append static to apply as tuples of
    ...
    def applymap(self, func: Callable, subset=None, **kwargs) -> "Styler":
        ...
        **kwargs : dict
        ...
        See Also
        --------
        Styler.where: Updates the HTML representation with a static which is
    ...
    def where(
        ...
        **kwargs,
        ...
        Updates the HTML representation with a static which is
        selected in accordance with the return value of a function.
    ...
    def set_table_attributes(self, attributes: str) -> "Styler":
        ...
        >>> df.static.set_table_attributes('class="pure-table"')
    ...
    def export(self) -> List[Tuple[Callable, Tuple, Dict]]:
        """
        Export the static to applied to the current Styler.

        Can be applied to a second static with ``Styler.use``.
        ...
        See Also
        --------
        Styler.use: Set the static on the current Styler.
        """
        return self._todo

    def use(self, styles: List[Tuple[Callable, Tuple, Dict]]) -> "Styler":
        """
        Set the static on the current Styler.

        Possibly uses static from ``Styler.export``.
        ...
        See Also
        --------
        Styler.export : Export the static to applied to the current Styler.
        """
    ...
    def set_table_styles(self, table_styles, axis=0, overwrite=True) -> "Styler":
        """
        Set the table static on a Styler.

        These are placed in a ``<static>`` tag before the generated HTML table.

        This function can be used to static the entire table, columns, rows or
        ...
        table_styles : list or dict
            ...
            should be a CSS selector that the static will be applied to
        ...
        overwrite : boolean, default True
            ...
            rules are preserved so most recent static set will dominate
    ...
    # -----------------------------------------------------------------------
    # A collection of "builtin" static
    # -----------------------------------------------------------------------
    ...
    def highlight_null(
        ...
        subset : label or list of labels, default None
            A valid slice for ``data`` to limit the static application to.
    ...
    def background_gradient(
        ...
        """
        Color the background in a gradient static.
    ...
    def set_properties(self, subset=None, **kwargs) -> "Styler":
        ...
        **kwargs : dict
        ...
        --------
        >>> df = pd.DataFrame(np.random.randn(10, 4))
        >>> df.static.set_properties(color="white", align="right")
        >>> df.static.set_properties(**{'background-color': 'yellow'})
        """
    ...
    def pipe(self, func: Callable, *args, **kwargs):
        ...
        **kwargs : optional
        ...
        .. code-block:: python
            ...
            f(g(df.static.set_precision(3), arg1=a), arg2=b, arg3=c)

        users can write:

        .. code-block:: python

            (df.static.set_precision(3)
               .pipe(g, arg1=a)
        ...
        static "transformations" can be interleaved with calls to the built-in
        Styler interface.
        ...
        within a sequence of other static modifications:
