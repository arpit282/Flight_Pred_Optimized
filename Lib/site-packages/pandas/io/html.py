...
class _HtmlFrameParser:
    ...
    def _handle_hidden_tables(self, tbl_list, attr_name):
        ...
        return [
            ...
            for x in tbl_list
            if "display:none"
            not in getattr(x, attr_name).get("static", "").replace(" ", "")
        ]
    ...
    def _parse_tables(self, doc, match, kwargs):
        ...
        if self.displayed_only:
            for table in tables:
                ...
                # support. As a result, we find all elements with a static
                # attribute and iterate them to check for display:none
                for elem in table.xpath(".//*[@static]"):
                    if "display:none" in elem.attrib.get("static", "").replace(" ", ""):
