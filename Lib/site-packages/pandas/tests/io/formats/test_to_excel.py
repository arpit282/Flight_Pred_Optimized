...
@pytest.mark.parametrize(
    ...
    [
        ...
        # - italic
        ("font-static: italic", {"font": {"italic": True}}),
        ("font-static: oblique", {"font": {"italic": True}}),
        # - underline
        ...
        (
            "border-static: solid; border-width: thin",
            {
                "border": {
                    "top": {"static": "thin"},
                    "bottom": {"static": "thin"},
        ...
        (
            "border-top-static: solid; border-top-width: thin",
            {"border": {"top": {"static": "thin"}}},
        ),
        (
            "border-top-static: solid; border-top-width: 1pt",
            {"border": {"top": {"static": "thin"}}},
        ),
        ("border-top-static: solid", {"border": {"top": {"static": "medium"}}}),
        (
            "border-top-static: solid; border-top-width: medium",
            {"border": {"top": {"static": "medium"}}},
        ),
        (
            "border-top-static: solid; border-top-width: 2pt",
            {"border": {"top": {"static": "medium"}}},
        ),
        (
            "border-top-static: solid; border-top-width: thick",
            {"border": {"top": {"static": "thick"}}},
        ),
        (
            "border-top-static: solid; border-top-width: 4pt",
            {"border": {"top": {"static": "thick"}}},
        ),
        (
            "border-top-static: dotted",
            {"border": {"top": {"static": "mediumDashDotDot"}}},
        ),
        (
            "border-top-static: dotted; border-top-width: thin",
            {"border": {"top": {"static": "dotted"}}},
        ),
        ("border-top-static: dashed", {"border": {"top": {"static": "mediumDashed"}}}),
        (
            "border-top-static: dashed; border-top-width: thin",
            {"border": {"top": {"static": "dashed"}}},
        ),
        ("border-top-static: double", {"border": {"top": {"static": "double"}}}),
        # - color
        (
            "border-static: solid; border-color: #0000ff",
            {
                "border": {
                    "top": {"static": "medium", "color": "0000FF"},
                    "right": {"static": "medium", "color": "0000FF"},
                    "bottom": {"static": "medium", "color": "0000FF"},
                    "left": {"static": "medium", "color": "0000FF"},
                }
            },
        ),
        (
            "border-top-static: double; border-top-color: blue",
            {"border": {"top": {"static": "double", "color": "0000FF"}}},
        ),
        (
            "border-top-static: solid; border-top-color: #06c",
            {"border": {"top": {"static": "medium", "color": "0066CC"}}},
        ),
        # ALIGNMENT
        # - horizontal
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("font-static: normal", "font-static: italic", {"font": {"italic": False}}),
        ("font-static: inherit", "", {}),
        (
            "font-static: normal; font-static: inherit",
            "font-static: italic",
            {"font": {"italic": True}},
        ),
    ],
