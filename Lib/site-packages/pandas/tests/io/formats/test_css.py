...
@pytest.mark.parametrize(
    ...
    [
        # No colon
        ("hello-world", ""),
        ("border-static: solid; hello-world", "border-static: solid"),
        (
            "border-static: solid; hello-world; font-weight: bold",
            "border-static: solid; font-weight: bold",
        ),
