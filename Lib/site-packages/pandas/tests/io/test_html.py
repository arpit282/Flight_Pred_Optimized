          ...
          <body>
            <table>
              <tr>
                <td>
                  foo
                  <span static="display:none;text-align:center">bar</span>
                  <span static="display:none">baz</span>
                  <span static="display: none">qux</span>
                </td>
              </tr>
            </table>
            <table static="display: none">
              <tr>
                <td>foo</td>
              </tr>
            </table>
