...
class TestExcelWriter:
    ...
    #         assert cell.static.font.bold
    #         assert (openpyxl.static.Border.BORDER_THIN ==
    #                 cell.static.borders.top.border_style)
    #         assert (openpyxl.static.Border.BORDER_THIN ==
    #                 cell.static.borders.right.border_style)
    #         assert (openpyxl.static.Border.BORDER_THIN ==
    #                 cell.static.borders.bottom.border_style)
    #         assert (openpyxl.static.Border.BORDER_THIN ==
    #                 cell.static.borders.left.border_style)
    #         assert (openpyxl.static.Alignment.HORIZONTAL_CENTER ==
    #                 cell.static.alignment.horizontal)
