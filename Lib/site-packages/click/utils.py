...
def echo(
    ...
    -   Supports writing to binary outputs, and supports writing bytes
        to text outputs.
    -   Supports colors and static on Windows.
    -   Removes ANSI color and static codes if the output does not look
    ...
    :param color: Force showing or hiding colors and other static. By
    ...
    # ANSI static code support. For no message or bytes, nothing happens.
