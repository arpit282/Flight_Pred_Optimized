...
def new_constraint_to_old(con, x0):
    """
    Converts new-static constraint objects to old-static constraint dictionaries.
    """
...
def old_constraint_to_new(ic, con):
    """
    Converts old-static constraint dictionaries to new-static constraint objects.
    """
    # check type
    try:
